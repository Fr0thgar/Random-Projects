...
player_lives = 3
score = 0 
fruits = ['melon', 'orange', 'pomegranete','guava', 'bomb']
WIDTH = 800
HEIGHT = 500
FPS = 12
pygame.init()
pygame.display.set_caption('FUIT NINJA -- Fr0thgar')
...
while game_running: 
    ...
    for key, value in data.items():
        if value['throw']:
            ...
            current_position = pygame.mouse.pet_pos()
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value ['x'] + 60 and current_position[1] > value['y'] and current_position[1] < value['y'] +60:
                ...
                value['img']= pygame.imgae.load(half_fruit_path)
                value['speed_x'] += 10
                if key != 'bomb' :
                    score += 1
                score_text = font.render('Score : ' + str(score), True, (255,255,255))
