...
root.resizable(0, 0)
root.title("Fr0thgar - Message Encoder and Decoder")

Label(root, text='ENCODE DECODE', font='arial 20 bold').pack()
Label(root, text='Fr0thgar', font='arial 20 bold').pack(side=BOTTOM)
...
Entry(root, font='arial 12 bold', textvariable=Result,
