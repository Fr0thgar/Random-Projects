...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.intro_label = Label(
            self, text='Welcome to real time currency converter', fg='blue', relief=tk.RAISED, borderwidth=3)
        ...
        self.from_currency_variable = ttk.Combobox(self, textvariable=self.from_currency_variable, value=list(
